...
public class CustomAdapterDetalhes extends ArrayAdapter<CardResponder> {
    ...
    public CustomAdapterDetalhes(Context context, int resource, ArrayList<CardResponder> objects) {
